...
0000000000000054 <test>:
  ...
  64:	0fe080e7          	jalr	254(ra) # 15e <fork>
  68:	ed09                	bnez	a0,82 <test+0x2e>
  6a:	4601                	li	a2,0
  6c:	85a2                	mv	a1,s0
  6e:	8526                	mv	a0,s1
  70:	00000097          	auipc	ra,0x0
  74:	216080e7          	jalr	534(ra) # 286 <execve>
  78:	70a2                	ld	ra,40(sp)
  7a:	7402                	ld	s0,32(sp)
  7c:	64e2                	ld	s1,24(sp)
  ...
  88:	0e2080e7          	jalr	226(ra) # 166 <wait>
  8c:	47b2                	lw	a5,12(sp)
...
000000000000009e <main>:
  ...
  b0:	0c2080e7          	jalr	194(ra) # 16e <open>
  b4:	4501                	li	a0,0
  b6:	00000097          	auipc	ra,0x0
  ba:	0d0080e7          	jalr	208(ra) # 186 <dup>
  be:	4501                	li	a0,0
  c0:	00000097          	auipc	ra,0x0
  c4:	0c6080e7          	jalr	198(ra) # 186 <dup>
...
0000000000000166 <wait>:
 166:	488d                	li	a7,3
 168:	00000073          	ecall
 16c:	8082                	ret

000000000000016e <open>:
 16e:	4889                	li	a7,2
 170:	00000073          	ecall
 174:	8082                	ret

0000000000000176 <sbrk>:
 176:	4891                	li	a7,4
 178:	00000073          	ecall
 17c:	8082                	ret

000000000000017e <getcwd>:
 17e:	48c5                	li	a7,17
 180:	00000073          	ecall
 184:	8082                	ret

0000000000000186 <dup>:
 186:	48dd                	li	a7,23
 188:	00000073          	ecall
 18c:	8082                	ret

000000000000018e <dup3>:
 18e:	48e1                	li	a7,24
 190:	00000073          	ecall
 194:	8082                	ret

0000000000000196 <mkdirat>:
 196:	02200893          	li	a7,34
 19a:	00000073          	ecall
 19e:	8082                	ret

00000000000001a0 <unlinkat>:
 1a0:	02300893          	li	a7,35
 1a4:	00000073          	ecall
 1a8:	8082                	ret

00000000000001aa <linkat>:
 1aa:	02500893          	li	a7,37
 1ae:	00000073          	ecall
 1b2:	8082                	ret

00000000000001b4 <umount2>:
 1b4:	02700893          	li	a7,39
 1b8:	00000073          	ecall
 1bc:	8082                	ret

00000000000001be <mount>:
 1be:	02800893          	li	a7,40
 1c2:	00000073          	ecall
 1c6:	8082                	ret

00000000000001c8 <chdir>:
 1c8:	03100893          	li	a7,49
 1cc:	00000073          	ecall
 1d0:	8082                	ret

00000000000001d2 <openat>:
 1d2:	03800893          	li	a7,56
 1d6:	00000073          	ecall
 1da:	8082                	ret

00000000000001dc <close>:
 1dc:	03900893          	li	a7,57
 1e0:	00000073          	ecall
 1e4:	8082                	ret

00000000000001e6 <pipe2>:
 1e6:	03b00893          	li	a7,59
 1ea:	00000073          	ecall
 1ee:	8082                	ret

00000000000001f0 <getdents64>:
 1f0:	03d00893          	li	a7,61
 1f4:	00000073          	ecall
 1f8:	8082                	ret

00000000000001fa <read>:
 1fa:	03f00893          	li	a7,63
 1fe:	00000073          	ecall
 202:	8082                	ret

0000000000000204 <write>:
 204:	04000893          	li	a7,64
 208:	00000073          	ecall
 20c:	8082                	ret

000000000000020e <fstat>:
 20e:	05000893          	li	a7,80
 212:	00000073          	ecall
 216:	8082                	ret
...
0000000000000222 <nanosleep>:
 222:	06500893          	li	a7,101
 226:	00000073          	ecall
 22a:	8082                	ret

000000000000022c <sched_yield>:
 22c:	07c00893          	li	a7,124
 230:	00000073          	ecall
 234:	8082                	ret

0000000000000236 <times>:
 236:	09900893          	li	a7,153
 23a:	00000073          	ecall
 23e:	8082                	ret

0000000000000240 <uname>:
 240:	0a000893          	li	a7,160
 244:	00000073          	ecall
 248:	8082                	ret

000000000000024a <gettimeofday>:
 24a:	0a900893          	li	a7,169
 24e:	00000073          	ecall
 252:	8082                	ret

0000000000000254 <brk>:
 254:	0d600893          	li	a7,214
 258:	00000073          	ecall
 25c:	8082                	ret

000000000000025e <munmap>:
 25e:	0d700893          	li	a7,215
 262:	00000073          	ecall
 266:	8082                	ret

0000000000000268 <getpid>:
 268:	0ac00893          	li	a7,172
 26c:	00000073          	ecall
 270:	8082                	ret

0000000000000272 <getppid>:
 272:	0ad00893          	li	a7,173
 276:	00000073          	ecall
 27a:	8082                	ret

000000000000027c <clone>:
 27c:	0dc00893          	li	a7,220
 280:	00000073          	ecall
 284:	8082                	ret

0000000000000286 <execve>:
 286:	0dd00893          	li	a7,221
 28a:	00000073          	ecall
 28e:	8082                	ret

0000000000000290 <mmap>:
 290:	0de00893          	li	a7,222
 294:	00000073          	ecall
 298:	8082                	ret

000000000000029a <wait4>:
 29a:	10400893          	li	a7,260
 29e:	00000073          	ecall
 2a2:	8082                	ret

00000000000002a4 <kernel_panic>:
 2a4:	18f00893          	li	a7,399
 2a8:	00000073          	ecall
 2ac:	8082                	ret
...
0000000000000338 <gets>:
 ...
 36a:	e94080e7          	jalr	-364(ra) # 1fa <read>
...
000000000000047a <putc>:
 ...
 48c:	d7c080e7          	jalr	-644(ra) # 204 <write>
...
0000000000000532 <vprintf>:
 ...
 57c:	3f0b0b13          	addi	s6,s6,1008 # 968 <digits>
 ...
 6b2:	2b290913          	addi	s2,s2,690 # 960 <malloc+0x190>
...
00000000000007d0 <malloc>:
 ...
 7f4:	19053503          	ld	a0,400(a0) # 980 <freep>
 ...
 820:	16448493          	addi	s1,s1,356 # 980 <freep>
 824:	5afd                	li	s5,-1
 826:	a0bd                	j	894 <malloc+0xc4>
 828:	00000797          	auipc	a5,0x0
 82c:	16078793          	addi	a5,a5,352 # 988 <base>
 830:	00000717          	auipc	a4,0x0
 834:	14f73823          	sd	a5,336(a4) # 980 <freep>
 838:	e39c                	sd	a5,0(a5)
 ...
 8a2:	8d8080e7          	jalr	-1832(ra) # 176 <sbrk>
